...
export async function POST(req) {
    ...
    const { nama_lengkap_user, alamat_lengkap_user, kode_pos_user, no_hp_user, catatan_user, dataPesanan } = await req.json()
    const data = { nama_lengkap_user, alamat_lengkap_user, kode_pos_user, no_hp_user, catatan_user, dataPesanan }
