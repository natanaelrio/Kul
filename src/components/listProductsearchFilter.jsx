...
export default function ListProductsearchFilter({ sortby, query }) {
    ...
    return (
        <div className={styles.container}>
            <div className={styles.fill}>
                <div className={styles.tulisan} style={sortby ? { backgroundColor: 'var(--color-primary) ', color: 'var(--color-white)' } : {}} onClick={setOpenFilter}><div>Sort Price</div> &nbsp; <FaSort /></div>
